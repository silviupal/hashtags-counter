package silviupal.hashtagscounter.presentation.base
...
import silviupal.hashtagscounter.common.extensions.copyToClipboard
import silviupal.hashtagscounter.common.extensions.pasteFromClipboard
...
import silviupal.hashtagscounter.presentation.adapterItems.HashtagCheckboxItem
import silviupal.hashtagscounter.presentation.models.HashtagCheckboxModel
        ...
        uiScope.launch {
            ...
            if (listFromDatabase.isEmpty()) {
                ...
                listFromDatabase.forEach {
                    items = items + HashtagCheckboxItem(HashtagCheckboxModel(
                        it.name))
                }
                ...
                fastAdapter.withEventHook(object : ClickEventHook<HashtagCheckboxItem>() {
                    ...
                    override fun onClick(v: View,
                        ...
                        fastAdapter.getAdapterItem(position).model.isChecked = (v as CheckBox).isChecked
